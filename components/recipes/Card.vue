<template>
  <Card
    class="z-10 h-fit w-[250px] gap-2 pt-2 pb-4 shadow-none transition-shadow hover:cursor-pointer hover:shadow-sm"
  ...
  >
    <SignedImage
      ...
      class="bg-secondary pointer-events-none mx-2 h-[150px] w-auto rounded-lg bg-cover bg-center object-cover md:w-[230px]"
      :class="{ 'bg-secondary': recipe.imageUrl }"
    />
